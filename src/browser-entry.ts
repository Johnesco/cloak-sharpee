/**
 * Browser Entry Point for The classic IF demonstration game by Roger Firth, implemented in Sharpee.
 *
...
async function start(): Promise<void> {
  console.log('=== The classic IF demonstration game by Roger Firth, implemented in Sharpee. BROWSER START ===');
